...
const HARDCODED_REVIEWS: Review[] = [
  {
    id: 'review-1',
    productId: 'product-1',
    customerName: 'Luiz Paulo',
    rating: 5,
    variant: 'PADRÃO',
    comment: 'Chegou antes do prazo e a instalação é bem simples e fácil',
    image: 'https://down-br.img.susercontent.com/br-11134103-81z1k-mha15twj94w092',
    createdAt: new Date('2025-01-01'),
  },
  {
    id: 'review-2',
    productId: 'product-1',
    customerName: 'Sidney Araújo',
    rating: 5,
    variant: 'PADRÃO',
    comment: 'Instalação: super simples. Qualidade: confiável, produto bom. Velocidade: muito boa. Gostei do sinal',
    image: 'https://down-br.img.susercontent.com/br-11134103-81z1k-mh25c5pweu4k0d',
    createdAt: new Date('2025-01-02'),
  },
  {
    id: 'review-3',
    productId: 'product-1',
    customerName: 'Quintino D.',
    rating: 5,
    variant: 'PADRÃO',
    comment: 'Chegou bem rápido e veio muito bem embalado, recomendo o vendedor',
    image: 'https://down-br.img.susercontent.com/br-11134103-81z1k-mgcbi8v6znk0cd',
    createdAt: new Date('2025-01-03'),
  },
  {
    id: 'review-4',
    productId: 'product-1',
    customerName: 'Adamo Jr.',
    rating: 5,
    variant: 'PADRÃO',
    comment: 'Muito top demais, já tinha comprado antes então já conhecia a marca e a entrega foi antecipada',
    image: 'https://down-br.img.susercontent.com/br-11134103-81z1k-mgnozh6dtr7pea',
    createdAt: new Date('2025-01-04'),
  },
  {
    id: 'review-5',
    productId: 'product-1',
    customerName: 'Iracy Pedro',
    rating: 4,
    variant: 'PADRÃO',
    comment: 'Produto chegou rápido, caixa super segura difícil de violar. Fácil instalação e ativação.',
    image: 'https://down-br.img.susercontent.com/br-11134103-820m1-mmvt6mblfaiqc1',
